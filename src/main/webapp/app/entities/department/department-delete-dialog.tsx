...
export const DepartmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.department.delete.question">
        <Translate contentKey="sampleApplicationApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
