...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.country.delete.question">
        <Translate contentKey="sampleApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
