...
export const EmployeeDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.employee.delete.question">
        <Translate contentKey="sampleApplicationApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
