    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobHistoryDetailsHeading">
          <Translate contentKey="sampleApplicationApp.jobHistory.detail.title">JobHistory</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="startDate">
              <Translate contentKey="sampleApplicationApp.jobHistory.startDate">Start Date</Translate>
            </span>
          </dt>
          <dd>
          ...
          <dt>
            <span id="endDate">
              <Translate contentKey="sampleApplicationApp.jobHistory.endDate">End Date</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.endDate ? <TextFormat value={jobHistoryEntity.endDate} type="date" format={APP_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="language">
              <Translate contentKey="sampleApplicationApp.jobHistory.language">Language</Translate>
            </span>
          </dt>
          <dd>{jobHistoryEntity.language}</dd>
          <dt>
            <Translate contentKey="sampleApplicationApp.jobHistory.job">Job</Translate>
          </dt>
          ...
          <dt>
            <Translate contentKey="sampleApplicationApp.jobHistory.employee">Employee</Translate>
          </dt>
