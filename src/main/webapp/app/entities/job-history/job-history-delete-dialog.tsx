...
export const JobHistoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.jobHistory.delete.question">
        <Translate contentKey="sampleApplicationApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
