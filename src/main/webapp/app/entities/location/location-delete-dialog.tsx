...
export const LocationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.location.delete.question">
        <Translate contentKey="sampleApplicationApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
