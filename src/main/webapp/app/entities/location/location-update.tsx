  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleApplicationApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="sampleApplicationApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('sampleApplicationApp.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('sampleApplicationApp.location.postalCode')}
              ...
              />
              <ValidatedField
                label={translate('sampleApplicationApp.location.city')}
                id="location-city"
                name="city"
                data-cy="city"
                type="text"
              />
              <ValidatedField
                label={translate('sampleApplicationApp.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('sampleApplicationApp.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
