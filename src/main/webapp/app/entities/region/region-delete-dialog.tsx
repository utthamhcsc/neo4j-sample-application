...
export const RegionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleApplicationApp.region.delete.question">
        <Translate contentKey="sampleApplicationApp.region.delete.question" interpolate={{ id: regionEntity.id }}>
